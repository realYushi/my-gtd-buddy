...
./scripts/reminders.sh completed 7
./scripts/reminders.sh stale 7
./scripts/reminders.sh orphan-projects
./scripts/reminders.sh waiting-age
./scripts/state.sh trends
```
...
```bash
./scripts/state.sh review <completed_count> "<focus>"
./scripts/state.sh weekly <completed> <processed> <deferred>
```
